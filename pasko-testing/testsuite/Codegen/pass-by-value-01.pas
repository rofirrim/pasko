...
CHECK: *** IR for '_P.sink_1'
CHECK-NEXT: function u0:0(i64) system_v {
CHECK-NEXT: block0(v0: i64):
CHECK-NEXT:     return
CHECK-NEXT: }
CHECK-NEXT: *** IR for '_P.sink_1' seems OK

CHECK: *** IR for '_P.source_1'
CHECK-NEXT: function u0:1() system_v {
CHECK-NEXT:     sig0 = (i64) system_v
CHECK-NEXT:     fn0 = colocated u0:0 sig0 ; _P.sink_1
CHECK-EMPTY:
CHECK-NEXT: block0:
...
CHECK-NEXT:     return
CHECK-NEXT: }
CHECK-NEXT: *** IR for '_P.source_1' seems OK
...
CHECK-NEXT:     fn1 = colocated u0:2 sig1 ; _P.sink_2
CHECK-EMPTY:
CHECK-NEXT: block0:
