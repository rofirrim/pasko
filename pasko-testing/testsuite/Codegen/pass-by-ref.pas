...
CHECK-NEXT: function u0:35(i64, i64) system_v {
...
CHECK-NEXT:     fn0 = colocated u0:35 sig0
CHECK-EMPTY: 
...
CHECK: *** IR for main
CHECK-NEXT: function u0:36(i32, i64) -> i32 system_v {
CHECK-NEXT:     ss0 = explicit_slot 8
CHECK-NEXT:     ss1 = explicit_slot 8
...
CHECK-NEXT:     fn4 = colocated u0:35 sig4
CHECK-EMPTY: 
