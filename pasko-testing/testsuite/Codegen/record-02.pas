...
CHECK-NEXT:     v18 = f64const 0x1.2666666666666p1
CHECK-NEXT:     v19 = global_value.i64 gv2
CHECK-NEXT:     v20 = iconst.i64 16
CHECK-NEXT:     v21 = iadd v19, v20  ; v20 = 16
CHECK-NEXT:     store v18, v21  ; v18 = 0x1.2666666666666p1
CHECK-NEXT:     v22 = iconst.i32 65
CHECK-NEXT:     v23 = global_value.i64 gv2
CHECK-NEXT:     v24 = iconst.i64 24
CHECK-NEXT:     v25 = iadd v23, v24  ; v24 = 24
CHECK-NEXT:     store v22, v25  ; v22 = 65
