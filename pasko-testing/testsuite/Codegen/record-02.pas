...
CHECK: *** IR for main
CHECK-NEXT: function u0:35(i32, i64) -> i32 system_v {
...
CHECK-NEXT:     store v16, v19  ; v16 = 1
CHECK-NEXT:     v20 = f64const 0x1.2666666666666p1
CHECK-NEXT:     v21 = global_value.i64 gv2
CHECK-NEXT:     v22 = iconst.i64 16
CHECK-NEXT:     v23 = iadd v21, v22  ; v22 = 16
CHECK-NEXT:     store v20, v23  ; v20 = 0x1.2666666666666p1
CHECK-NEXT:     v24 = iconst.i32 65
CHECK-NEXT:     v25 = global_value.i64 gv2
CHECK-NEXT:     v26 = iconst.i64 24
CHECK-NEXT:     v27 = iadd v25, v26  ; v26 = 24
CHECK-NEXT:     store v24, v27  ; v24 = 65
