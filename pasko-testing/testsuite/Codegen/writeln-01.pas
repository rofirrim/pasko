...
CHECK-NEXT:     gv2 = symbol colocated userextname8 ; [string: 'hello']
...
CHECK-NEXT:     fn5 = u0:6 sig5 ; __pasko_write_textfile_newline
CHECK-NEXT:     fn6 = u0:7 sig6 ; __pasko_write_textfile_str
CHECK-NEXT:     fn7 = u0:8 sig7 ; __pasko_write_textfile_i64
CHECK-NEXT:     fn8 = u0:9 sig8 ; __pasko_write_textfile_f64
CHECK-EMPTY: 
...
CHECK-NEXT:     call fn6(v19, v20, v21)  ; v21 = 5
...
CHECK-NEXT:     call fn8(v31, v32, v33, v34)  ; v32 = 0x1.3ae147ae147aep0, v33 = 0, v34 = 0
...
CHECK-NEXT:     call fn8(v36, v37, v38, v39)  ; v37 = 0x1.3ae147ae147aep0, v38 = 10, v39 = 0
CHECK-NEXT:     call fn5(v36)
...
CHECK-NEXT:     call fn8(v41, v42, v43, v44)  ; v42 = 0x1.3ae147ae147aep0, v43 = 10, v44 = 3
CHECK-NEXT:     call fn5(v41)
