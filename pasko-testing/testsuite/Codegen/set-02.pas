...
// CHECK-NEXT:     ss3 = explicit_slot 24 ; [set-constructor]
...
// CHECK-NEXT:     gv4 = symbol colocated userextname10 ; c
// CHECK-NEXT:     gv5 = symbol colocated userextname16 ; x
...
// CHECK-NEXT:     fn6 = u0:7 sig6 ; __pasko_set_copy
// CHECK-NEXT:     fn7 = u0:8 sig7 ; __pasko_set_union
// CHECK-NEXT:     fn8 = u0:9 sig8 ; __pasko_set_difference
// CHECK-NEXT:     fn9 = u0:10 sig9 ; __pasko_set_intersection
// CHECK-NEXT:     fn10 = u0:11 sig10 ; __pasko_set_contains
// CHECK-EMPTY:
