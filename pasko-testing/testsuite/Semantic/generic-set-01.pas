...
CHECK-NEXT:             │  └─╴ExprBinOp 11:8 + set of integer
...
CHECK-NEXT:             │  └─╴ExprBinOp 12:8 * set of integer
...
CHECK-NEXT:             │  └─╴ExprBinOp 13:8 - set of integer
...
CHECK-NEXT:             │  └─╴ExprBinOp 15:8 + set of integer
...
CHECK-NEXT:             │  └─╴ExprBinOp 16:8 * set of integer
...
CHECK-NEXT:             │  └─╴ExprBinOp 17:8 - set of integer
...
CHECK-NEXT:             │  └─╴ExprBinOp 20:8 <= boolean
...
CHECK-NEXT:             │  └─╴ExprBinOp 21:8 >= boolean
...
CHECK-NEXT:             │  └─╴ExprBinOp 22:8 <= boolean
...
CHECK-NEXT:             │  └─╴ExprBinOp 23:8 >= boolean
