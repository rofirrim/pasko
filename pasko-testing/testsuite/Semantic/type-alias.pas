...
CHECK-NEXT:       │     └─╴TypeIdentifier 10:7 "my_integer" my_integer (an alias of integer)
CHECK-NEXT:       └─╴Statement 13:1 
CHECK-NEXT:          └─╴StmtCompound 13:1 
CHECK-NEXT:             ├─╴StmtAssignment 14:3 lhs my_integer (an alias of integer) rhs integer
CHECK-NEXT:             │  ├─╴AssigVariable 14:3 "a" my_integer (an alias of integer)
