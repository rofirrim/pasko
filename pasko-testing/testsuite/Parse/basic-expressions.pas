...
CHECK-NEXT:             │  └─╴ExprBinOp 11:8 + <<no-type>>
...
CHECK-NEXT:             │  └─╴ExprBinOp 12:8 - <<no-type>>
...
CHECK-NEXT:             │  └─╴ExprBinOp 13:8 * <<no-type>>
...
CHECK-NEXT:             │  └─╴ExprBinOp 14:8 div <<no-type>>
...
CHECK-NEXT:             │  └─╴ExprBinOp 15:8 mod <<no-type>>
...
CHECK-NEXT:             │  └─╴ExprBinOp 16:8 / <<no-type>>
...
CHECK-NEXT:             │  └─╴ExprUnOp 17:8 - <<no-type>>
...
CHECK-NEXT:                └─╴ExprBinOp 21:8 * <<no-type>>
CHECK-NEXT:                   ├─╴ExprParentheses 21:8 
CHECK-NEXT:                   │  └─╴ExprBinOp 21:9 + <<no-type>>
