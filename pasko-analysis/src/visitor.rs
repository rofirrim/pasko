...
macro_rules! define_visitor {
    ($class:ident) => {
        paste! {
          fn [<visit_pre_ $class:snake>](&self, _n: &'a ast::$class, span: &span::SpanLoc, id: span::SpanId) -> bool {
            self.unhandled_node_pre(stringify!($class), span, id);
            true
          }
          fn [<visit_post_ $class:snake>](&self, _n: &'a ast::$class, span: &span::SpanLoc, id: span::SpanId)  {
...
macro_rules! define_visitor_leaf {
    ($class:ident) => {
        paste! {
          fn [<visit_ $class:snake>](&self, _n: &'a ast::$class, span: &span::SpanLoc, id: span::SpanId) {
...
macro_rules! define_visitor_mut {
    ($class:ident) => {
        paste! {
          fn [<visit_pre_ $class:snake>](&mut self, _n: &'a ast::$class, span: &span::SpanLoc, id: span::SpanId) -> bool {
            self.unhandled_node_pre(stringify!($class), span, id);
            true
          }
          fn [<visit_post_ $class:snake>](&mut self, _n: &'a ast::$class, span: &span::SpanLoc, id: span::SpanId)  {
            self.unhandled_node_post(stringify!($class), span, id);
          }
        }
    };
...
macro_rules! define_visitor_leaf_mut {
    ($class:ident) => {
        paste! {
          fn [<visit_ $class:snake>](&mut self, _n: &'a ast::$class, span: &span::SpanLoc, id: span::SpanId) {
            self.unhandled_node_leaf(stringify!($class), span, id);
          }
        }
    };
...
pub trait Visitable<'a> {
    fn walk(&'a self, v: &dyn Visitor<'a>, span: &span::SpanLoc, id: span::SpanId);
    fn walk_mut(&'a self, v: &mut dyn VisitorMut<'a>, span: &span::SpanLoc, id: span::SpanId);
}

macro_rules! define_visitable_leaf {
    ($class:ident) => {
        impl<'a> Visitable<'a> for ast::$class {
            fn walk(&'a self, v: &dyn Visitor<'a>, span: &span::SpanLoc, id: span::SpanId) {
...
macro_rules! define_visit_method {
  ($class:ident, $self_:ident, $visitor:ident, $body:block) => {
    fn walk(&'a $self_, $visitor: &dyn Visitor<'a>, span: &span::SpanLoc, id: span::SpanId) {
      paste! {
...
macro_rules! define_visit_method_mut {
  ($class:ident, $self_:ident, $visitor:ident, $body_mut:block) => {
    fn walk_mut(&'a $self_, $visitor: &mut dyn VisitorMut<'a>, span: &span::SpanLoc, id: span::SpanId) {
      paste! {
        if $visitor. [<visit_pre_ $class:snake>]($self_, span, id) {
            $body_mut
            $visitor. [<visit_post_ $class:snake>]($self_, span, id);
